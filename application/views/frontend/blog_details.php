                    ...
                    <div class="col-lg-8 posts-list">
                        <div class="single-post">
                            <div class="feature-img">
                                <img class="img-fluid" src="<?= base_url('assets/frontend')?>/img/blog/single_blog_1.png" alt="">
                            </div>
                            ...
                            <div class="navigation-area">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                        <div class="thumb">
                                            <a href="#">
                                                <img class="img-fluid" src="<?= base_url('assets/frontend')?>/img/post/preview.png" alt="">
                                            </a>
                                        </div>
                                        <div class="arrow">
                                            <a href="#">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                                        ...
                                        <div class="thumb">
                                            <a href="#">
                                                <img class="img-fluid" src="<?= base_url('assets/frontend')?>/img/post/next.png" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
