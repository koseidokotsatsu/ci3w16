                        ...
                        <tbody>
                            <tr>
                                <td class="product-thumbnail">
                                    <img src="<?= base_url('assets/frontend/') ?>images/product_02.png" alt="Image" class="img-fluid">
                                </td>
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    <img src="<?= base_url('assets/frontend/') ?>images/product_01.png" alt="Image" class="img-fluid">
                                </td>
                                <td class="product-name">
