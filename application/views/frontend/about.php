...
<body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="<?= base_url('assets/frontend')?>/img/logo/loder.png" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.html"><img src="<?= base_url('assets/frontend')?>/img/logo/logo.png" alt=""></a>
                            </div>
                        </div>
    ...
    <main>
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="about-img ">
                            <div class="about-font-img d-none d-lg-block">
                                <img src="<?= base_url('assets/frontend')?>/img/gallery/about2.png" alt="">
                            </div>
                            <div class="about-back-img ">
                                <img src="<?= base_url('assets/frontend')?>/img/gallery/about1.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-testimonial text-center">
                        ...
                        <div class="testimonial-caption ">
                            <div class="testimonial-top-cap">
                                <img src="<?= base_url('assets/frontend')?>/img/gallery/testimonial.png" alt="">
                            ...
                            <div class="testimonial-founder d-flex align-items-center justify-content-center">
                                <div class="founder-img">
                                    <img src="<?= base_url('assets/frontend')?>/img/gallery/Homepage_testi.png" alt="">
                                </div>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img big-img" style="background-image: url(<?= base_url('')?>assets/frontend/img/gallery/gallery1.png);"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="background-image: url(<?= base_url('')?>assets/frontend/img/gallery/gallery2.png);"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="background-image: url(<?= base_url('')?>assets/frontend/img/gallery/gallery3.png);"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="background-image: url(<?= base_url('')?>assets/frontend/img/gallery/gallery4.png);"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="background-image: url(<?= base_url('')?>assets/frontend/img/gallery/gallery5.png);"></div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img big-img" style="background-image: url(<?= base_url('')?>assets/frontend/img/gallery/gallery6.png);"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="contact-form-main">
            ...
            <div class="from-left d-none d-lg-block">
                <img src="<?= base_url('assets/frontend')?>/img/gallery/contact_form.png" alt="">
            </div>
        </div>
        <!-- Contact form End -->
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="gallery-box">
                            <div class="single-gallery">
                                <div class="gallery-img " style="background-image: url(<?= base_url('')?>assets/frontend/img/gallery/gallery1.png);"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="gallery-box">
                            <div class="single-gallery">
                                <div class="gallery-img " style="background-image: url(<?= base_url('')?>assets/frontend/img/gallery/gallery2.png);"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="gallery-box">
                            <div class="single-gallery">
                                <div class="gallery-img " style="background-image: url(<?= base_url('')?>assets/frontend/img/gallery/gallery3.png);"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="gallery-box">
                            <div class="single-gallery">
                                <div class="gallery-img " style="background-image: url(<?= base_url('')?>assets/frontend/img/gallery/gallery4.png);"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="gallery-box">
                            <div class="single-gallery">
                                <div class="gallery-img " style="background-image: url(<?= base_url('')?>assets/frontend/img/gallery/gallery5.png);"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="gallery-box">
                            <div class="single-gallery">
                                <div class="gallery-img " style="background-image: url(<?= base_url('')?>assets/frontend/img/gallery/gallery6.png);"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="<?= base_url('assets/frontend')?>/img/gallery/team2.png" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="<?= base_url('assets/frontend')?>/img/gallery/team3.png" alt="">
                            </div>
                            <div class="team-caption">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="<?= base_url('assets/frontend')?>/img/gallery/team1.png" alt="">
                            </div>
                            <div class="team-caption">
    ...
    <footer>
        <!--? Footer Start-->
        <div class="footer-area section-bg" data-background="<?= base_url('assets/frontend')?>/img/gallery/footer_bg.jpg">
            <div class="container">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-8">
                            <div class="single-footer-caption mb-50">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="<?= base_url('assets/frontend')?>/img/logo/logo2_footer.png" alt=""></a>
                                </div>
                            </div>
                        </div>
