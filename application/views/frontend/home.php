                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="<?= base_url('home') ?>"><img src="<?= base_url('assets/frontend/img') ?>/logo/logo.png" style="width: 200px;" alt="" /></a>
                            </div>
                        </div>
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="<?= base_url('home/doctor') ?>">Doctors</a></li>
                                            <li><a href="<?= base_url('home/departement') ?>">Department</a></li>
                                            <li>
                                                <a href="<?= base_url('home/blog') ?>">Blog</a>
                                                <ul class="submenu">
                                                    <li><a href="<?= base_url('home/blog') ?>">Blog</a></li>
                                                    <li>
                                                        <a href="<?= base_url('home/blog_details') ?>">Blog Details</a>
                                                    </li>
                                                    <li><a href="<?= base_url('home/element') ?>">Element</a></li>
                                                </ul>
                                            </li>
                            ...
                            <div class="row align-items-center no-gutters">
                                ...
                                <div class="col-lg-5">
                                    <div class="dept_thumb">
                                        <img src="<?= base_url('assets/frontend/img') ?>/gallery/department_man.png" alt="" />
                                    </div>
                                </div>
                            </div>
                            <!-- single_content  -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img big-img" style="
                        background-image: url(<?= base_url('assets/frontend/img') ?>/gallery/gallery1.png);
                      "></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="
                        background-image: url(<?= base_url('assets/frontend/img') ?>/gallery/gallery2.png);
                      "></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="
                        background-image: url(<?= base_url('assets/frontend/img') ?>/gallery/gallery3.png);
                      "></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="
                        background-image: url(<?= base_url('assets/frontend/img') ?>/gallery/gallery4.png);
                      "></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="
                        background-image: url(<?= base_url('assets/frontend/img') ?>/gallery/gallery5.png);
                      "></div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img big-img" style="
                        background-image: url(<?= base_url('assets/frontend/img') ?>/gallery/gallery6.png);
                      "></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial-caption">
                            <div class="testimonial-top-cap">
                                ...
                                <p>
                                    ...
                                    and it will care for you. Eat clean it will care for yout
                                    hard.”
                                </p>
                            </div>
                            <!-- founder -->
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="<?= base_url('assets/frontend/img') ?>/gallery/blog1.png" alt="" />
                            </div>
                            <div class="blogs-cap">
                                <div class="date-info">
                                    <span>Health</span>
                                ...
                                <h4>
                                    <a href="blog_details.html">Amazing Places To Visit In Summer</a>
                                </h4>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="<?= base_url('assets/frontend/img') ?>/gallery/blog2.png" alt="" />
                            </div>
                            <div class="blogs-cap">
                                <div class="date-info">
                                    <span>Checkup</span>
                                ...
                                <h4>
                                    <a href="blog_details.html">Developing Creativithout Losing Visual</a>
                                </h4>
                                <a href="blog_details.html" class="read-more1">Read more</a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="<?= base_url('assets/frontend/img') ?>/gallery/blog3.png" alt="" />
                            </div>
                            <div class="blogs-cap">
                                <div class="date-info">
                                    <span>Operation</span>
                                ...
                                <h4>
                                    <a href="blog_details.html">Winter Photography Tips from Glenn</a>
                                </h4>
                                <a href="blog_details.html" class="read-more1">Read more</a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-8">
                            <div class="single-footer-caption mb-50">
                                ...
                                <div class="footer-logo">
                                    <a href="<?= base_url('home') ?>"><img src="<?= base_url('assets/frontend/img') ?>/logo/logo2_footer.png" style="width: 200px;" alt="" /></a>
                                </div>
                            </div>
                        </div>
