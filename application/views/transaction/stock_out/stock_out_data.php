                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center" width="160px">
                            <a id="set_detail" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modal-detail" data-barcode="<?= $data->barcode ?>" data-itemname="<?= $data->item_name ?>" data-detail="<?= $data->detail ?>" data-qty="<?= $data->qty ?>" data-date="<?= indo_date($data->date) ?>" data-name="<?= $data->name ?>">
